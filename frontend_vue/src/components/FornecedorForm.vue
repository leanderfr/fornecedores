...
<div  class="flex flex-col w-[95%] max-w-[1300px] overflow-hidden pt-8 "  id='fornecedorForm'>
  ...
  <div  class="flex flex-col w-full bg-white relative rounded-lg"  >
    ...
    <!-- campos do form -->
    <div class="flex flex-col w-full h-auto  px-4 my-3" >
      ...
      <div class="flex flex-row w-full gap-[10px] ">
        ...
        <div class="flex flex-row w-full ">
          ...
          <div class="flex flex-col basis-[150px] text-right mr-4">  
            ...
            <div class='h-[40px] pt-1'>Nome:</div>
            <div class='h-[40px] pt-1'>Rua, Av.:</div>          
            <div class='h-[40px] pt-1'>Número:</div>          
            <div class='h-[40px] pt-1'>Bairro:</div>          
            <div class='h-[40px] pt-1'>CEP:</div>          
            <div class='h-[40px] pt-1'>Cidade:</div>          
            <div class='h-[40px] pt-1'>UF:</div>          
            <div class='h-[40px] pt-1'>País:</div>          
          </div>
