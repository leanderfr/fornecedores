...
<template>
  ...
  <div class='topMenu' id='topMenu' > 
    ...
    <template v-if='cars.length!=0' >
        <div :id="'itemMenu' + car.id" class='itemMenu' :class='{itemMenuSelected: props.selectedCar==car.id}' v-for='car in cars' :key='car.id' 
            :style="{ 
...
import { slidingMessage, toWheeltopMenu } from './assets/js/utils.js'
